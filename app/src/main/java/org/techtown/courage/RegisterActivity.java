    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(userID.equals("") || userPassword.equals("") || userRegion.equals("") || userEmail.equals("") || userGender.equals("")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                ...
                RegisterRequest registerRequest = new RegisterRequest(userID, userPassword, userGender, userRegion, userEmail, responseListener);
                RequestQueue queue = Volley.newRequestQueue(RegisterActivity.this);
